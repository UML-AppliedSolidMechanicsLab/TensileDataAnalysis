	...
	public class Polynomial
	{
        ...
        public void PolynomialFit(int inPolynomialOrder, double[] inX, double[] inY, 
    		...
    		for (I = 0; I < inPolynomialOrder+1; I++){
    			for (j = 0; j < inPolynomialOrder+1; j++){
    				for (k = 0; k < inCount; k++){
    					a[I, j] = a[I, j] + System.Math.Pow(inX[k], (j + I ));
    				}
    			}
    			for (k = 0; k < inCount; k++){
    				b[I, 0] = b[I, 0] + inY[k] * System.Math.Pow(inX[k], (I));
    			}
    		}
    		...
    		for (I = 0; I < inCount; I++){
    			...
    			residualSumSquared = residualSumSquared + System.Math.Pow(residual, 2);
        		Ybar = Ybar + inY[I];
    		}  		
    		Ybar = Ybar / inCount; 
    		...
    		for (I = 0; I < inPolynomialOrder+1; I++ ){
    			...
    			SEi[I] = System.Math.Pow(SEySquared *temp , 0.5); //absolute value required for negative Aout...???
			}
    		//calculate the total sum of squares:
    		for (I = 0; I <inCount; I++){
    			VarYaboutMean = inY[I] - Ybar;
    			SSyy = SSyy + System.Math.Pow(VarYaboutMean, 2);
    		}
